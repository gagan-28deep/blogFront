    ...
    <section className="rounded-md bg-black/70 p-2">
      <div className="flex items-center justify-center bg-white px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <h2 className="text-2xl font-bold leading-tight text-black">Reset Your Account Password</h2>
          <form onSubmit={handleSubmit(handleUserResetPassword)} className="mt-8">
              ...
              <div>
                ...
                <div className="mt-2">
                  ...
                  {errors.oldPassword?.type === "required" && (
                      <p className="text-red-700">Old Password is required.</p>
                    )}
                </div>
              </div>
              <div>
                ...
                <div className="mt-2">
                  ...
                  {errors?.newPassword?.type === "required" && (
                      <p className="text-red-700">New Password is required.</p>
                    )}
